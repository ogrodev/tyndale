...
Erstelle `tyndale.config.json` im Stammverzeichnis deines Projekts, oder führe `npx tyndale init` aus, um eine zu erzeugen.
...
| `translate.tokenBudget` | `number` | `50000` | Token-Budget pro AI-Übersetzungs-Batch |
