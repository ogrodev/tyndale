...
import { extractStrings, type ExtractionError } from '../extract/string-extractor.js';
import { extractFromAstroFile } from '../extract/astro-extract.js';
import { extractDictionaries } from '../extract/dict-extractor.js';
import { validateTComponent, detectStaleHashes } from '../extract/validator.js';
import { writeExtractionOutput } from '../extract/output-writer.js';
import { formatExtractionReport, type ExtractionReport } from '../utils/reporter.js';
